          ...
          <div className="flex flex-col gap-4">
            <div className="grid grid-cols-1 gap-3">
              ...
              >
                ...
                {loading && mode === 'login' && !email ? 'Conectando...' : 'Google'}
              </Button>

              <div className="grid grid-cols-2 gap-3">
                <Button 
                  variant="outline" 
                  className="flex items-center justify-center gap-2 font-bold py-6 border-zinc-200 dark:border-zinc-800 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 transition-all active:scale-[0.98]"
