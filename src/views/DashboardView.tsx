  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <Card 
        ...
        className="bg-zinc-900 border-none p-8 sm:p-12 text-white relative overflow-hidden group shadow-[0_20px_50px_rgba(0,0,0,0.3)] dark:shadow-[0_20px_60px_rgba(0,0,0,1)] ring-1 ring-zinc-800 cursor-pointer transition-all active:scale-[0.98]"
      >
