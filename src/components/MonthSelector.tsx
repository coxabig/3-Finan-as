...
export function MonthSelector() {
  ...
  return (
    <div className="w-full flex justify-center">
      <div className="flex items-center w-fit bg-white dark:bg-zinc-900/50 backdrop-blur-md px-2 sm:px-3 py-1.5 rounded-2xl shadow-[0_2px_10px_-4px_rgba(0,0,0,0.1)] border border-zinc-100 dark:border-zinc-800 gap-1 sm:gap-2 mb-10 transition-all hover:border-zinc-200 dark:hover:border-zinc-700">
        <button 
